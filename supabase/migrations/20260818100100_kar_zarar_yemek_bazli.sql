-- 20260818100100_kar_zarar_yemek_bazli.sql
--
-- Kâr/zarar: maliyet yemek bazlı çıkan porsiyondan.
--
-- Her kalemin kendi porsiyonu ve kendi reçete maliyeti var; günün maliyeti
-- bunların toplamı. Ciro yiyen/faturalanan kişiden gelir, kâr aradaki farktır.
...
as $$
  ...
  okul_gunler as (
    select n.id as nokta_id, n.ad as nokta, n.liste_id, n.varsayilan_cikan_porsiyon,
  ...
  manuel_gunler as (
    select
      n.id as nokta_id, n.ad as nokta, n.liste_id, n.varsayilan_cikan_porsiyon, d.tarih,
  ...
  gunler as (
    select
      ...
      c.porsiyon as cikan,
      c.maliyet,
      -- Porsiyon hiç girilmemiş ve varsayılan da yoksa hesap eksiktir
      (not c.girilmis and b.varsayilan_cikan_porsiyon = 0 and b.kisi + b.misafir > 0)
        as cikan_bilinmiyor
    from birlesik b
    cross join lateral public.gun_cikan(
      b.nokta_id, b.liste_id, b.tarih,
      coalesce(nullif(b.varsayilan_cikan_porsiyon, 0), b.kisi + b.misafir)
    ) c
  )
  select
    nokta,
