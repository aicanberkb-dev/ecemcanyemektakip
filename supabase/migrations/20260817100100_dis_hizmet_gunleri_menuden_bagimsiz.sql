-- 20260817100100_dis_hizmet_gunleri_menuden_bagimsiz.sql
--
-- Dış hizmet yerlerinde hizmet günü artık menü girilmiş olmasına bağlı değil.
--
-- Menü listesi henüz doldurulmamış bir yerde ayın tamamı tek güne düşüyordu;
-- sabit kişi sayısı da işe yaramaz hâle geliyordu. Artık hafta içi her gün
-- hizmet günü sayılır: menü yoksa yalnızca o günün maliyeti 0 kalır. Hizmet
-- verilmeyen günler (resmî tatil vb.) o güne 0 yazılarak dışarıda bırakılır.
...
as $$
  ...
  manuel_tarihler as (
    -- Hafta içi her gün hizmet günüdür
    select n.id as nokta_id, d::date as tarih
    from noktalar n
    cross join generate_series(p_bas, p_bit, interval '1 day') d
    where n.okul_id is null and extract(isodow from d) < 6
    union
    -- Elle girilmiş günler (hafta sonu çalışıldıysa o da dahil)
