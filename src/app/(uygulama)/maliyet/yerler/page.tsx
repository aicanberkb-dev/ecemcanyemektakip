    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-sm text-solgun">
          ...
          fiyatı ve yiyen kişi sayısı sistemin kendi içinden gelir. Buradaki{' '}
          <strong>çıkan porsiyon</strong> normalde kaç kişilik gönderildiğidir; günlük ve
          yemek bazlı sapmalar Kâr/Zarar ekranından girilir.
        </p>
      </div>
